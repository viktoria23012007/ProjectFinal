...
#### Сценарий 7. 
Через ссылку "355 курсов всех направлений" в блоке "Направления обучения" и далее аналогично сценариям 1 / 2.

#### Сценарий 8. 
Через ссылку "Каталог курсов" в блоке "Обучение" внизу страницы и далее аналогично сценариям 1 / 2.

#### Сценарий 9. 
Через ссылку "Популярные курсы" в блоке "Обучение" внизу страницы и далее аналогично сценариям 1 / 2.

#### Сценарий 10. 
Через ссылку "Программирование" в блоке "Обучение" внизу страницы и далее аналогично сценариям 1 / 2.

### 1.2. Сценарии тестирования формы
...
#### Сценарий 8. Отправка пустой (с незаполненными полями) формы
...
#### Сценарий 9. Отправка формы с данными из ранее успешно отправленной формы
